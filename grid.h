...
private:
   ...
   /**
    * Rotates the row once
    */
   void rotateRowOnce(int r);

    /**
     * Rotates the column once
     */
    void rotateColumnOnce(int c);
...
//    */
   ...
   void eraseColNodes (Node * colHead);
   void eraseRowNodes (Node * rowHead);
